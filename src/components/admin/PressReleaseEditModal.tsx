...
interface PressReleaseEditModalProps {
  isOpen: boolean;
  editingPressRelease: PressRelease | null;
...
const PressReleaseEditModal: React.FC<PressReleaseEditModalProps> = ({
  isOpen,
  editingPressRelease,
  formData,
  setFormData,
...
export default PressReleaseEditModal;
